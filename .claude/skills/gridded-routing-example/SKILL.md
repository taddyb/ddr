...
description: How the DDM30 (ISIMIP 0.5°) gridded routing example is wired through ddr — data products, the Ddm30 dataset class, the negative-coefficient MC regime, and the two-tier acceptance gates. Local mirror of wiki/plan-gridded-juniata.md, which is gitignored; the tracked home for plans is docs/superpowers/plans/.
---
